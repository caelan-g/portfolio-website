...
export default function Footer() {
  return (
    <>
      <div className="text-md flex justify-between py-6  border-t-neutral-600 border-t mx-4 md:mx-14 text-neutral-500">
        <div className="flex gap-12">
          <p className="transition-all col-start-1 flex">
            Made with{" "}
            <svg
