    ...
    <section className="w-screen grid grid-cols-5 gap-8 px-8 lg:px-48 py-12 lg:py-36 bg-gray-50 text-black min-h-screen">
      <div className="w-full lg:flex-row flex-col flex items-start col-span-5 lg:col-span-3">
        <div className="">
          ...
          <p className="text-md font-normal text-neutral-800 ">
            Built and launched Islands, a gamified study tracking app with
          ...
          <div className="left-36 w-full lg:col-span-3 lg:px-12 justify-center z-10">
            <Image
      ...
      <div className="flex lg:flex-col flex-col col-span-full lg:col-span-2 gap-4 mt-6 w-full">
        <div className="flex gap-4 flex-col">
          <Image
            src="/images/islands/dashboard.png"
            alt="Island"
            width={1920}
            height={1080}
          ...
          />
          <Image
            src="/images/islands/archipelago.png"
            alt="Island"
            width={1920}
            height={1080}
            className="rounded-md object-cover w-full shadow-md"
